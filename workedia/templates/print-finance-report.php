...
<body>
    ...
    <div class="header">
        <div style="text-align: right;">
            ...
            <p style="margin: 5px 0 0 0; font-size: 12px;"><?php echo esc_html($workedia['address']); ?></p>
            <p style="margin: 2px 0 0 0; font-size: 12px;"><?php echo esc_html($workedia['phone']); ?></p>
        </div>
    ...
    <div class="footer">
        تم استخراج هذا التقرير آلياً من نظام Workedia الرقمي - <?php echo home_url(); ?>
    </div>
</body>
</html>
