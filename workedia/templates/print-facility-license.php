    ...
    <div class="license-page">
        <div class="inner-border">
            <div class="header">
                <div style="text-align: center; width: 100%;">
                    <?php if ($workedia['workedia_logo']): ?>
                        <img src="<?php echo esc_url($workedia['workedia_logo']); ?>" style="max-height: 100px; margin-bottom: 20px;">
                    <?php endif; ?>
                    <div style="font-weight: 700; font-size: 22px; color: <?php echo $appearance['dark_color']; ?>;"><?php echo esc_html($workedia['workedia_name']); ?></div>
            ...
            <div class="content" style="margin-top: 50px; line-height: 2.2;">
                بناءً على اللوائح التنظيمية المنصوص عليها، تشهد Workedia بأن المنشأة:<br>
            ...
            <div class="footer" style="margin-bottom: 30px;">
                <div style="text-align: center;">
                    <img src="https://api.qrserver.com/v1/create-qr-code/?size=120x120&data=<?php echo urlencode(admin_url('admin-ajax.php?action=workedia_print_facility&member_id='.$member_id)); ?>" style="border: 1px solid #eee; padding: 5px;">
                    <p style="font-size: 11px; margin-top: 8px;">رمز التحقق الرقمي</p>
                </div>

                <div style="text-align: center; width: 300px;">
                    <p style="font-weight: 700; margin-bottom: 40px;">يعتمد،، مسؤول Workedia العام</p>
                    <p style="font-size: 22px; font-weight: 900;"><?php echo esc_html($workedia['workedia_officer_name']); ?></p>
