...
(function(window) {
    ...
    window.workediaSubmitPayment = function(btn) {
        ...
        .then(res => {
            if (res.success) {
                workediaShowNotification('تم تسجيل الدفعة بنجاح');
                if (typeof workediaOpenFinanceModal === 'function') {
                    workediaOpenFinanceModal(form.querySelector('[name="member_id"]').value);
                } else {
                    location.reload();
                }
            } else {
    ...
    window.workediaOpenFinanceModal = function(memberId) {
                ...
                case 'global-settings':
                    if ($is_admin || $is_sys_admin || $is_administrator) {
                        ...
                        <div class="workedia-tabs-wrapper" style="display: flex; gap: 10px; margin-bottom: 20px; border-bottom: 2px solid #eee; overflow-x: auto; white-space: nowrap; padding-bottom: 10px;">
                            ...
                            <button class="workedia-tab-btn <?php echo $sub == 'professional' ? 'workedia-active' : ''; ?>" onclick="workediaOpenInternalTab('professional-settings', this)">الدرجات والتخصصات</button>
                            <button class="workedia-tab-btn <?php echo $sub == 'finance' ? 'workedia-active' : ''; ?>" onclick="workediaOpenInternalTab('finance-settings', this)">الرسوم والغرامات</button>
