...
<div class="workedia-content-wrapper" dir="rtl">
    ...
    <div class="workedia-tabs-wrapper" style="display: flex; gap: 10px; margin-bottom: 20px; border-bottom: 2px solid #eee;">
        ...
        <a href="<?php echo add_query_arg('role_filter', 'administrator'); ?>" class="workedia-tab-btn <?php echo ($_GET['role_filter'] ?? '') == 'administrator' ? 'workedia-active' : ''; ?>" style="text-decoration:none;">مدير النظام (Administrator)</a>
        <a href="<?php echo add_query_arg('role_filter', 'subscriber'); ?>" class="workedia-tab-btn <?php echo ($_GET['role_filter'] ?? '') == 'subscriber' ? 'workedia-active' : ''; ?>" style="text-decoration:none;">مستخدم (Subscriber)</a>
    </div>
    <?php endif; ?>
        ...
        <form method="get" style="display: grid; grid-template-columns: 1fr 1fr auto; gap: 20px; align-items: end;">
            ...
            <div class="workedia-form-group" style="margin-bottom:0;">
                ...
                <select name="role_filter" class="workedia-select">
                    ...
                    <option value="administrator" <?php selected($_GET['role_filter'] ?? '', 'administrator'); ?>>مدير النظام (Administrator)</option>
                    <option value="subscriber" <?php selected($_GET['role_filter'] ?? '', 'subscriber'); ?>>مستخدم (Subscriber)</option>
                </select>
            </div>
            <?php endif; ?>
                            ...
                            <td>
                                <div class="workedia-actions-dropdown">
                                    ...
                                    <div class="workedia-actions-content">
                                        ...
                                        <a href="javascript:void(0)" onclick="workediaDeleteUser(<?php echo $u->ID; ?>, '<?php echo esc_js($u->display_name); ?>')" class="workedia-action-item workedia-delete" style="color:#e53e3e;">
                ...
                <div style="display:grid; grid-template-columns: 1fr 1fr; gap:20px;">
                    ...
                    <div class="workedia-form-group">
                        ...
                        <select name="role" id="edit_off_role" class="workedia-select">
                            ...
                            <?php endif; ?>
                            <option value="subscriber">مستخدم (Subscriber)</option>
                        </select>
                    </div>
                    <div class="workedia-form-group">
