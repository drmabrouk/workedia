...
<head>
    ...
    <style>
        ...
        .workedia-info h1 { margin: 0; font-size: 24px; color: <?php echo $appearance['dark_color']; ?>; }
    ...
    <div class="invoice-box">
        <div class="header">
            <div class="workedia-info">
                ...
                <p><?php echo esc_html($workedia['address']); ?></p>
                <p><?php echo esc_html($workedia['phone']); ?></p>
            </div>
        ...
        <table class="invoice-table">
            ...
            <tbody>
                <tr>
                    <td style="font-weight: 700; color: var(--workedia-dark-color);">
                        <?php
        ...
        <div style="margin-top: 60px; display: flex; justify-content: space-between;">
            ...
            <div style="text-align: center;">
                <p>ختم Workedia الرسمي</p>
                <div style="width: 100px; height: 100px; border: 2px dashed #eee; border-radius: 50%; margin: 10px auto;"></div>
            </div>
        </div>

        <div class="footer">
            <p>هذه فاتورة إلكترونية معتمدة صادرة عن نظام <?php echo esc_html($workedia['workedia_name']); ?>.</p>
