...
<head>
    ...
    <style>
        ...
        .workedia-name { font-size: 26px; font-weight: 900; color: <?php echo $appearance['dark_color']; ?>; }
...
<body>
    ...
    <div class="license-page">
        <div class="header">
            ...
            <div style="font-size: 18px;"><?php echo esc_html($workedia['address']); ?></div>
            <div class="title">تصريح مزاولة المهنة</div>
        </div>

        <div class="content">
            تشهد إدارة <?php echo esc_html($workedia['workedia_name']); ?> بأن السيد/ <span class="field"><?php echo esc_html($member->name); ?></span><br>
            الحامل للرقم القومي: <span class="field"><?php echo esc_html($member->national_id); ?></span><br>
            والمسجل بWorkedia برقم عضوية: <span class="field"><?php echo esc_html($member->membership_number); ?></span><br>
            قد استوفى كافة الشروط والضوابط القانونية لمزاولة مهنة الرياضة بصفة: <span class="field"><?php echo esc_html(Workedia_Settings::get_professional_grades()[$member->professional_grade] ?? $member->professional_grade); ?></span><br>
            تخصص: <span class="field"><?php echo esc_html(Workedia_Settings::get_specializations()[$member->specialization] ?? $member->specialization); ?></span>.<br><br>
        ...
        <div class="footer">
            <div class="qr-code-box">
                <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=<?php echo urlencode(admin_url('admin-ajax.php?action=workedia_print_license&member_id='.$member->id)); ?>" class="qr-code">
                <p style="font-size: 10px; text-align: center; margin-top: 5px;">تحقق من صحة الترخيص</p>
            </div>

            <div class="signature-box">
                <p>يعتمد،،،</p>
                <p style="font-weight: 900; margin-top: 20px;"><?php echo esc_html($workedia['workedia_officer_name']); ?></p>
                <p style="font-size: 14px;">مسؤول Workedia العام</p>
        ...
        <div style="position: absolute; bottom: 20mm; left: 0; right: 0; text-align: center; font-size: 12px; color: #777; border-top: 1px solid #eee; padding-top: 10px; margin: 0 20mm;">
            هذا الترخيص ملك للWorkedia ويجب إبرازه عند الطلب. أي تلاعب في بياناته يعرض صاحبه للمساءلة القانونية.
        </div>
    </div>
</body>
</html>
