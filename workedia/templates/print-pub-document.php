...
<div class="page-header">
    <?php if (!empty($workedia['authority_logo'])): ?>
        <img src="<?php echo esc_url($workedia['authority_logo']); ?>" style="height: 60px;" alt="Authority Logo">
    <?php else: ?>
        <div></div>
    <?php endif; ?>

    <div style="text-align: center; flex: 1;">
        <h2 style="margin: 0; font-size: 18px; color: <?php echo $primary_color; ?>; font-weight: 900;"><?php echo esc_html($workedia['workedia_name']); ?></h2>
        <p style="margin: 3px 0 0 0; font-size: 11px; font-weight: bold; color: #666;"><?php echo esc_html($workedia['authority_name']); ?></p>
    </div>

    <?php if (!empty($workedia['workedia_logo'])): ?>
        <img src="<?php echo esc_url($workedia['workedia_logo']); ?>" style="height: 70px;" alt="Workedia Logo">
    <?php else: ?>
        <div></div>
    <?php endif; ?>
</div>
...
<div class="page-footer">
    <div style="font-size: 10px; color: #666;">
        <p style="margin: 0;"><?php echo esc_html($workedia['address']); ?></p>
        <p style="margin: 0;">هاتف: <?php echo esc_html($workedia['phone']); ?> | بريد: <?php echo esc_html($workedia['email']); ?></p>
        <?php if (!empty($workedia['website_url'])): ?>
            <p style="margin: 0;">الموقع الإلكتروني: <?php echo esc_url($workedia['website_url']); ?></p>
        <?php endif; ?>
                ...
                <td>
                    <div class="content-body">
                        ...
                        <div class="preview-header no-print">
                            ...
                            <div style="text-align: center; flex: 1;">
                                <h2 style="margin: 0; font-size: 18px; color: <?php echo $primary_color; ?>; font-weight: 900;"><?php echo esc_html($workedia['workedia_name']); ?></h2>
                                <p style="margin: 3px 0 0 0; font-size: 11px; color: #666;"><?php echo esc_html($workedia['authority_name']); ?></p>
                            </div>
                            <?php if (!empty($workedia['workedia_logo'])): ?>
                                <img src="<?php echo esc_url($workedia['workedia_logo']); ?>" style="height: 70px;" alt="Workedia Logo">
                            <?php endif; ?>
                        ...
                        <?php if ($doc_type === 'certificate'): ?>
                            <div class="certificate-seal">ختم Workedia<br>المعتمد</div>
                        <?php endif; ?>
                        ...
                        <div class="preview-footer no-print">
                            <div style="font-size: 10px; color: #666;">
                                <p style="margin: 0;"><?php echo esc_html($workedia['address']); ?></p>
                                <p style="margin: 0;">هاتف: <?php echo esc_html($workedia['phone']); ?></p>
                                <?php if (!empty($workedia['website_url'])): ?>
                                    <p style="margin: 0;">الموقع: <?php echo esc_url($workedia['website_url']); ?></p>
                                <?php endif; ?>
                            </div>
                            <div class="codes-block">
                                <?php if (!empty($options['qr'])): ?>
