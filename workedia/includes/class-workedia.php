...
class Workedia {
    ...
    private function load_dependencies() {
        ...
        require_once WORKEDIA_PLUGIN_DIR . 'includes/class-workedia-finance.php';
    ...
    private function define_public_hooks() {
        ...
        $this->loader->add_action('wp_ajax_workedia_add_survey', $plugin_public, 'ajax_add_survey');
        $this->loader->add_action('wp_ajax_workedia_cancel_survey', $plugin_public, 'ajax_cancel_survey');
        ...
        $this->loader->add_action('wp_ajax_workedia_record_payment_ajax', $plugin_public, 'ajax_record_payment');
        $this->loader->add_action('wp_ajax_workedia_delete_transaction_ajax', $plugin_public, 'ajax_delete_transaction');
        ...
        $this->loader->add_action('wp_ajax_workedia_add_service', $plugin_public, 'ajax_add_service');
        $this->loader->add_action('wp_ajax_workedia_update_service', $plugin_public, 'ajax_update_service');
        $this->loader->add_action('wp_ajax_workedia_get_services_html', $plugin_public, 'ajax_get_services_html');
        ...
        $this->loader->add_action('wp_ajax_workedia_get_member_finance_html', $plugin_public, 'ajax_get_member_finance_html');
        $this->loader->add_action('wp_ajax_workedia_update_license_ajax', $plugin_public, 'ajax_update_license');
        $this->loader->add_action('wp_ajax_workedia_print_license', $plugin_public, 'ajax_print_license');
        $this->loader->add_action('wp_ajax_workedia_update_facility_ajax', $plugin_public, 'ajax_update_facility');
        $this->loader->add_action('wp_ajax_workedia_print_facility', $plugin_public, 'ajax_print_facility');
        $this->loader->add_action('wp_ajax_workedia_print_invoice', $plugin_public, 'ajax_print_invoice');
        $this->loader->add_action('wp_ajax_workedia_print_service_request', $plugin_public, 'ajax_print_service_request');
        ...
        $this->loader->add_action('wp_ajax_nopriv_workedia_submit_membership_request', $plugin_public, 'ajax_submit_membership_request');
        $this->loader->add_action('wp_ajax_nopriv_workedia_track_membership_request', $plugin_public, 'ajax_track_membership_request');
        $this->loader->add_action('wp_ajax_workedia_track_membership_request', $plugin_public, 'ajax_track_membership_request');
        $this->loader->add_action('wp_ajax_nopriv_workedia_submit_membership_request_stage3', $plugin_public, 'ajax_submit_membership_request_stage3');
        $this->loader->add_action('wp_ajax_workedia_submit_membership_request_stage3', $plugin_public, 'ajax_submit_membership_request_stage3');
        $this->loader->add_action('wp_ajax_workedia_process_membership_request', $plugin_public, 'ajax_process_membership_request');
        ...
        $this->loader->add_action('wp_ajax_workedia_upload_document', $plugin_public, 'ajax_upload_document');
        $this->loader->add_action('wp_ajax_workedia_get_documents', $plugin_public, 'ajax_get_documents');
        $this->loader->add_action('wp_ajax_workedia_delete_document', $plugin_public, 'ajax_delete_document');
        $this->loader->add_action('wp_ajax_workedia_get_document_logs', $plugin_public, 'ajax_get_document_logs');
        $this->loader->add_action('wp_ajax_workedia_log_document_view', $plugin_public, 'ajax_log_document_view');
        $this->loader->add_action('wp_ajax_workedia_get_pub_template', $plugin_public, 'ajax_get_pub_template');
        $this->loader->add_action('wp_ajax_workedia_generate_pub_doc', $plugin_public, 'ajax_generate_pub_doc');
        $this->loader->add_action('wp_ajax_workedia_print_pub_doc', $plugin_public, 'ajax_print_pub_doc');
        $this->loader->add_action('wp_ajax_workedia_save_pub_identity', $plugin_public, 'ajax_save_pub_identity');
        $this->loader->add_action('wp_ajax_workedia_save_pub_template', $plugin_public, 'ajax_save_pub_template');
        ...
        $this->loader->add_action('wp_ajax_workedia_export_finance_report', $plugin_public, 'ajax_export_finance_report');
